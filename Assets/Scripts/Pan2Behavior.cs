...
public class Pan2Behavior : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Input.GetKeyDown("x") && pan2Key.activeSelf && gameManger.GetComponent<GameGlobals>().currentScreen == SCREEN.COOK && overcooking && flipRequired){
            pan2Key.SetActive(false);
